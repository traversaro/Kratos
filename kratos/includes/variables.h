...
namespace Kratos
{
    ...
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_FLUID_VECTOR_2 )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( ADJOINT_FLUID_VECTOR_3 )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( AUX_ADJOINT_FLUID_VECTOR_1 )
