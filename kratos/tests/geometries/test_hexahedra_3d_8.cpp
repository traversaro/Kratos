...
namespace Kratos {
    ...
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8EdgesNumber, KratosCoreGeometriesFastSuite) {
      ...
      KRATOS_STATIC_CHECK_EQUAL(geomRegLen1->EdgesNumber(), 12);
      KRATOS_STATIC_CHECK_EQUAL(geomRegLen2->EdgesNumber(), 12);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8FacesNumber, KratosCoreGeometriesFastSuite) {
      ...
      KRATOS_STATIC_CHECK_EQUAL(geomRegLen1->FacesNumber(), 6);
      KRATOS_STATIC_CHECK_EQUAL(geomRegLen2->FacesNumber(), 6);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8Length, KratosCoreGeometriesFastSuite) {
      ...
      KRATOS_STATIC_CHECK_NEAR(geomRegLen1->Length(), 0.353553, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geomRegLen2->Length(), 1.000000, TOLERANCE);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8Area, KratosCoreGeometriesFastSuite) {
      ...
      KRATOS_STATIC_CHECK_NEAR(geomRegLen1->Area(), 1.0, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geomRegLen2->Area(), 8.0, TOLERANCE);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8Volume, KratosCoreGeometriesFastSuite) {
      ...
      KRATOS_STATIC_CHECK_NEAR(geomRegLen1->Volume(), 1.0, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geomRegLen2->Volume(), 8.0, TOLERANCE);
  	}
    ...
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8BoxIntersection, KratosCoreGeometriesFastSuite) {
      ...
      KRATOS_STATIC_CHECK(hexahedron->HasIntersection(Point(-0.6,-0.6,-0.6), Point(0.6,0.6,0.6)));

      //hexahedron contains the box
      KRATOS_STATIC_CHECK(hexahedron->HasIntersection(Point(-.25,-.25,-.25), Point(.25,.25,.25)));

      //hexahedron intersects the box
      KRATOS_STATIC_CHECK(hexahedron->HasIntersection(Point(.25,.25,.25), Point(1.0,1.0,1.0)));

      //hexahedron not intersects the box
      KRATOS_STATIC_CHECK_IS_FALSE(hexahedron->HasIntersection(Point(.51,.51,.51), Point(1.1,1.1,1.1)));
    }
    ...
    */
    KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8PointLocalCoordinates, KratosCoreGeometriesFastSuite) {
        ...
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords(0), 0.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords(1), 0.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords(2), 0.0, TOLERANCE);
        ...
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_1(0), 1.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_1(1), 0.0, TOLERANCE);
        ...
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_2(0), 0.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_2(1),-1.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_2(2), 0.0, TOLERANCE);
        ...
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_3(1), 0.3, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(baricentre_local_coords_face_3(2), 1.0, TOLERANCE);
        ...
        KRATOS_STATIC_CHECK_NEAR(local_coords_outside_point(0), 1.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(local_coords_outside_point(1), 1.0, TOLERANCE);
        KRATOS_STATIC_CHECK_NEAR(local_coords_outside_point(2), 1.0, TOLERANCE);
    }
  ...
  KRATOS_TEST_CASE_IN_SUITE(Hexahedra3D8ShapeFunctionsValues, KratosCoreGeometriesFastSuite) {
      ...
      coord[1] = 1.0 / 4.0;
      coord[2] = 1.0 / 16.0;
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(0, coord), 0.0439453125, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(1, coord), 0.1318359375, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(2, coord), 0.2197265625, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(3, coord), 0.0732421875, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(4, coord), 0.0498046875, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(5, coord), 0.1494140625, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(6, coord), 0.2490234375, TOLERANCE);
      KRATOS_STATIC_CHECK_NEAR(geom->ShapeFunctionValue(7, coord), 0.0830078125, TOLERANCE);
