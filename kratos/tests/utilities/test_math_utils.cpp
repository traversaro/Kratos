...
namespace Kratos
{
    namespace Testing
    {
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsHeron, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_NEAR(area, 0.5, tolerance);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsAbs, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(absolute, 1.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsMin, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(min, 0.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsMax, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(max, 1.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsDetMat, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_NEAR(det, 1.0, tolerance);
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsCofactor, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(cofactor, 1.0);
            ...
            KRATOS_STATIC_CHECK_EQUAL(cofactor, -2.0);
            ...
            KRATOS_STATIC_CHECK_NEAR(cofactor, 9.0, tolerance);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsCofactorMatrix, KratosCoreFastSuite)
        {
            ...
            for (unsigned i = 0; i < ref33.size1(); ++i)
                for (unsigned j = 0; j < ref33.size2(); ++j)
                    KRATOS_STATIC_CHECK_NEAR(cof_mat(i,j), ref33(i,j), tolerance);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsGenDetMat, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_NEAR(det, 4.0, tolerance);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsInvMat, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_NEAR(I11(0,0), 1.0, tolerance);
            ...
            for (unsigned int i = 0; i < 2; i++)
            {
                for (unsigned int j = 0; j < 2; j++)
                {
                    if (i == j)
                    {
                        KRATOS_STATIC_CHECK_NEAR(I22(i,j), 1.0, tolerance);
                    }
                    else
                    {
                        KRATOS_STATIC_CHECK_NEAR(I22(i,j), 0.0, tolerance);
                    }
                }
            }
            ...
            for (unsigned int i = 0; i < 3; i++)
            {
                for (unsigned int j = 0; j < 3; j++)
                {
                    if (i == j)
                    {
                        KRATOS_STATIC_CHECK_NEAR(I33(i,j), 1.0, tolerance);
                    }
                    else
                    {
                        KRATOS_STATIC_CHECK_NEAR(I33(i,j), 0.0, tolerance);
                    }
                }
            }
            ...
            for (unsigned int i = 0; i < 4; i++)
            {
                for (unsigned int j = 0; j < 4; j++)
                {
                    if (i == j)
                    {
                        KRATOS_STATIC_CHECK_NEAR(I44(i,j), 1.0, tolerance);
                    }
                    else
                    {
                        KRATOS_STATIC_CHECK_NEAR(I44(i,j), 0.0, tolerance);
                    }
                }
            }
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsInvertMatrix, KratosCoreFastSuite)
        {
            ...
            for (unsigned int i = 0; i < i_dim; i++) {
                for (unsigned int j = 0; j < i_dim; j++) {
                    if (i == j) {
                        KRATOS_STATIC_CHECK_NEAR(I(i,j), 1.0, tolerance);
                    } else {
                        KRATOS_STATIC_CHECK_NEAR(I(i,j), 0.0, tolerance);
                    }
                }
            }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsSolve, KratosCoreFastSuite)
        {
            ...
            for (std::size_t i = 0; i < i_dim; i++) {
                KRATOS_STATIC_CHECK_NEAR(ref_x[i], x[i], tolerance);
            }
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsSign, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(sign, -1);
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsEigen, KratosCoreFastSuite)
        {
            ...
            for (unsigned int i = 0; i < 3; i++)
            {
                ...
                {
                    KRATOS_STATIC_CHECK_NEAR(auxmat33(i,j), mat33(i,j), tolerance);
                }
            }

            KRATOS_STATIC_CHECK_EQUAL(converged, true);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsDot, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(c, 0.0);
            KRATOS_STATIC_CHECK_EQUAL(d, 0.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsNorm, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(b, 1.0);
            KRATOS_STATIC_CHECK_EQUAL(c, 1.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsStableNormUnderflow, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(b, 1e-162);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsStableNormOverflow, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(b, 1e155);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsVectorAngleTest1, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(angle, Globals::Pi/2.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsVectorAngleTest2, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(angle, Globals::Pi);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsVectorAngleTest3, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(angle, Globals::Pi/3.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsCross, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(c[2], 2.0);
            KRATOS_STATIC_CHECK_EQUAL(d[2], 1.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsOrthonormalBasis, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(b[0], 1.0);
            KRATOS_STATIC_CHECK_EQUAL(c[2], -1.0);
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsTensor, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(c(0,0), 0.0);
            KRATOS_STATIC_CHECK_EQUAL(c(1,0), 2.0);
            KRATOS_STATIC_CHECK_EQUAL(c(0,1), 0.0);
            KRATOS_STATIC_CHECK_EQUAL(c(1,1), 0.0);
        }
        ...
        KRATOS_TEST_CASE_IN_SUITE(MathUtilsMatrixOperations, KratosCoreFastSuite)
        {
            ...
            KRATOS_STATIC_CHECK_EQUAL(a(0,0), 2.0);
            KRATOS_STATIC_CHECK_EQUAL(a(1,0), 0.0);
            KRATOS_STATIC_CHECK_EQUAL(a(0,1), 0.0);
            KRATOS_STATIC_CHECK_EQUAL(a(1,1), 2.0);

            MathUtils<double>::SubtractMatrix(a, b, 0 ,0);

            KRATOS_STATIC_CHECK_EQUAL(a(0,0), 1.0);
            KRATOS_STATIC_CHECK_EQUAL(a(1,0), 0.0);
            KRATOS_STATIC_CHECK_EQUAL(a(0,1), 0.0);
            KRATOS_STATIC_CHECK_EQUAL(a(1,1), 1.0);
