                                                             ...
                                                             double Tolerance = 1e-7)
{
    ...
    KRATOS_STATIC_CHECK_NEAR(DetJ_Deriv, finite_difference_detJ_deriv, Tolerance);
}
                                                              ...
                                                              double Tolerance = 1e-7)
{
    ...
    KRATOS_STATIC_CHECK(DN_DX_Deriv.size1() != 0);
    KRATOS_STATIC_CHECK(DN_DX_Deriv.size2() != 0);
        ...
        for (unsigned j = 0; j < DN_DX_Deriv.size2(); ++j)
            {
                ...
                KRATOS_STATIC_CHECK_NEAR(DN_DX_Deriv(i, j), finite_difference_ij, Tolerance);
            }
}
