...
namespace Testing {
    ...
    KRATOS_TEST_CASE_IN_SUITE(PlaneApproximationUtilityTriangle, KratosCoreFastSuite)
    {
        ...
        KRATOS_STATIC_CHECK_NEAR(d_1, -0.5, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_2,  0.5, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_3,  0.0, 1e-6);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(PlaneApproximationUtilityDiamond, KratosCoreFastSuite)
    {
        ...
        KRATOS_STATIC_CHECK_NEAR(d_1, 0.0674564, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_2, -0.547956, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_3, 0.547956, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_4, -0.0674564, 1e-6);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(PlaneApproximationUtilityCircleTriangleIntersection, KratosCoreFastSuite)
    {
        ...
        KRATOS_STATIC_CHECK_NEAR(d_1, -0.0353553, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_2, -0.0353553, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_3, 0.0353553, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(d_4, 0.0353553, 1e-6);
    }
    ...
    KRATOS_TEST_CASE_IN_SUITE(PlaneApproximationUtilityAlignedIntersection, KratosCoreFastSuite)
    {
        ...
        KRATOS_STATIC_CHECK_NEAR(base_point_coords[0], 1.0/3.0, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(base_point_coords[1], 1.0/3.0, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(base_point_coords[2], 0.0, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(normal[0], 0.0, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(normal[1], 0.0, 1e-6);
        KRATOS_STATIC_CHECK_NEAR(normal[2], 1.0, 1e-6);
    }
