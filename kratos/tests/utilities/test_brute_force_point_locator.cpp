...
KRATOS_TEST_CASE_IN_SUITE(BruteForcePointLocatorTriangleElement, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(found_id, elem_id_to_be_found);
    KRATOS_STATIC_CHECK_EQUAL(shape_function_values.size(), 3);

    KRATOS_STATIC_CHECK_NEAR(shape_function_values[0], 0.65, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[1], 0.1,  1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[2], 0.25, 1e-06);
}
...
KRATOS_TEST_CASE_IN_SUITE(BruteForcePointLocatorQuadrilateralElement, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(found_id, elem_id_to_be_found);
    KRATOS_STATIC_CHECK_EQUAL(shape_function_values.size(), 4);

    KRATOS_STATIC_CHECK_NEAR(shape_function_values[0], 0.452231, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[1], 0.0316039,  1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[2], 0.0337157, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[3], 0.48245, 1e-06);
}
...
KRATOS_TEST_CASE_IN_SUITE(BruteForcePointLocatorTetrahedraElement, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[0], 0.530166, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[1], 0.121616,  1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[2], 0.0769547, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[3], 0.271263, 1e-06);
}
...
KRATOS_TEST_CASE_IN_SUITE(BruteForcePointLocatorHexahedraElement, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(found_id, elem_id_to_be_found);
    KRATOS_STATIC_CHECK_EQUAL(shape_function_values.size(), 8);

    KRATOS_STATIC_CHECK_NEAR(shape_function_values[0], 0.197609, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[1], 0.0590793,  1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[2], 0.0242583, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[3], 0.0811397, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[4], 0.348142, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[5], 0.104084, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[6], 0.0427376, 1e-06);
    KRATOS_STATIC_CHECK_NEAR(shape_function_values[7], 0.142949, 1e-06);
}
...
KRATOS_TEST_CASE_IN_SUITE(BruteForcePointLocatorNode, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(found_id, node_id_to_be_found);
}
...
KRATOS_TEST_CASE_IN_SUITE(BruteForcePointLocatorQuadrilateralCondition, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(found_id, cond_id_to_be_found);
    KRATOS_STATIC_CHECK_EQUAL(shape_function_values.size(), 4);
