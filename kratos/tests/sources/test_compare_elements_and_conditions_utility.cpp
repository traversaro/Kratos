...
Condition::Pointer CreateCustomCondition2D3N(Condition::IndexType Id)
{
...
KRATOS_TEST_CASE_IN_SUITE(IsSame_Element_Element, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(r_custom_element_2d_3n_1, *p_custom_element_2d_3n_2));
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(&r_custom_element_2d_3n_1, &(*p_custom_element_2d_3n_2)));
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(*p_custom_element_2d_3n_2, r_custom_element_2d_3n_1));
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(&(*p_custom_element_2d_3n_2), &r_custom_element_2d_3n_1));
    // different element type, same geometry type.
    const Element& r_element_2d_3n = KratosComponents<Element>::Get("Element2D3N");
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(r_element_2d_3n, *p_custom_element_2d_3n_1));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&r_element_2d_3n, &(*p_custom_element_2d_3n_1)));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(*p_custom_element_2d_3n_1, r_element_2d_3n));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&(*p_custom_element_2d_3n_1), &r_element_2d_3n));
    ...
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(r_custom_element_2d_3n_1, r_custom_element_2d_4n_3));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&r_custom_element_2d_3n_1, &r_custom_element_2d_4n_3));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(r_custom_element_2d_4n_3, r_custom_element_2d_3n_1));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&r_custom_element_2d_4n_3, &r_custom_element_2d_3n_1));
}

KRATOS_TEST_CASE_IN_SUITE(IsSame_Condition_Condition, KratosCoreFastSuite)
{
    auto p_custom_condition_2d_3n_1 = CreateCustomCondition2D3N(1);
    const Condition& r_custom_condition_2d_3n_1 = *p_custom_condition_2d_3n_1;
    auto p_custom_condition_2d_3n_2 = CreateCustomCondition2D3N(2);
    // same condition type, same geometry type.
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(r_custom_condition_2d_3n_1, *p_custom_condition_2d_3n_2));
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(&r_custom_condition_2d_3n_1, &(*p_custom_condition_2d_3n_2)));
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(*p_custom_condition_2d_3n_2, r_custom_condition_2d_3n_1));
    KRATOS_STATIC_CHECK(GeometricalObject::IsSame(&(*p_custom_condition_2d_3n_2), &r_custom_condition_2d_3n_1));
    // different condition type, same geometry type.
    const Condition& r_condition_2d_3n = KratosComponents<Condition>::Get("Condition2D3N");
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(r_condition_2d_3n, *p_custom_condition_2d_3n_1));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&r_condition_2d_3n, &(*p_custom_condition_2d_3n_1)));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(*p_custom_condition_2d_3n_1, r_condition_2d_3n));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&(*p_custom_condition_2d_3n_1), &r_condition_2d_3n));
    ...
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(r_custom_condition_2d_3n_1, r_custom_condition_2d_4n_3));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&r_custom_condition_2d_3n_1, &r_custom_condition_2d_4n_3));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(r_custom_condition_2d_4n_3, r_custom_condition_2d_3n_1));
    KRATOS_STATIC_CHECK_IS_FALSE(GeometricalObject::IsSame(&r_custom_condition_2d_4n_3, &r_custom_condition_2d_3n_1));
}
...
KRATOS_TEST_CASE_IN_SUITE(GetRegisteredNameElement, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(component_name, "Element2D3N");
    CompareElementsAndConditionsUtility::GetRegisteredName(r_element_2d_3n, component_name);
    KRATOS_STATIC_CHECK_NOT_EQUAL(component_name, "Element");
    CompareElementsAndConditionsUtility::GetRegisteredName(&r_element_2d_3n, component_name);
    KRATOS_STATIC_CHECK_NOT_EQUAL(component_name, "Element");
}
...
KRATOS_TEST_CASE_IN_SUITE(GetRegisteredNameCondition, KratosCoreFastSuite)
{
    ...
    KRATOS_STATIC_CHECK_EQUAL(component_name, "Condition2D3N");
    CompareElementsAndConditionsUtility::GetRegisteredName(&r_condition_2d_3n, component_name);
    KRATOS_STATIC_CHECK_EQUAL(component_name, "Condition2D3N");
    CompareElementsAndConditionsUtility::GetRegisteredName(r_condition_2d_3n, component_name);
    KRATOS_STATIC_CHECK_NOT_EQUAL(component_name, "Condition");
    CompareElementsAndConditionsUtility::GetRegisteredName(&r_condition_2d_3n, component_name);
    KRATOS_STATIC_CHECK_NOT_EQUAL(component_name, "Condition");
}
