...
//              }
    ...
    */
        ...
        ) const override
    {
        ...
        rTangentXi = second_point - first_point;

        // We compute the normal
        rNormal[0] = second_point[1] -  first_point[1];
        rNormal[1] =  first_point[0] - second_point[0];
        rNormal[2] = 0.0;

        MathUtils<double>::CrossProduct(rTangentEta, rTangentXi, rNormal);
