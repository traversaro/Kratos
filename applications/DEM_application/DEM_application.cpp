...
KRATOS_CREATE_VARIABLE(
    WeakPointerVector<Element>, NODE_TO_NEIGH_ELEMENT_POINTER)
...
KRATOS_CREATE_VARIABLE(DEMDiscontinuumConstitutiveLaw::Pointer,
    DEM_DISCONTINUUM_CONSTITUTIVE_LAW_POINTER)
...
KRATOS_CREATE_VARIABLE(int, TABLE_NUMBER)
...
// MATERIAL PARAMETERS
KRATOS_CREATE_VARIABLE(
    std::vector<PropertiesProxy>, VECTOR_OF_PROPERTIES_PROXIES)
...
KRATOS_CREATE_VARIABLE(double, BEAM_CONTACT_AREA)
...
KRATOS_CREATE_VARIABLE(
    WeakPointerVector<Element>, NEIGHBOUR_PARTICLE_BLOCK_ELEMENTS)
...
KRATOS_CREATE_VARIABLE(
    WeakPointerVector<Element>, NEIGHBOUR_PARTICLE_OF_RIGID_FACE)
...
#undef ____CONVERT_TO_STRING
    ...
    KRATOS_REGISTER_VARIABLE(BEAM_CONTACT_AREA)
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(
        INLET_INITIAL_PARTICLES_VELOCITY)
