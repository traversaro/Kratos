...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_CROSS_SECTION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PLANAR_MOMENT_OF_INERTIA_X)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PLANAR_MOMENT_OF_INERTIA_Y)
    // *************** Continuum only END ***************
