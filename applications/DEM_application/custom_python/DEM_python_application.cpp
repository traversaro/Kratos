...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TABLE_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TABLE_VELOCITY_COMPONENT)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INERTIA_TENSOR_XX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INERTIA_TENSOR_YY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_INERTIA_TENSOR_ZZ)
    // *************** Continuum only END ***************
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PARTICLE_FRICTION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_CONTACT_AREA)
    ...
    //SLS DEM-FEM
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WALL_FRICTION)
