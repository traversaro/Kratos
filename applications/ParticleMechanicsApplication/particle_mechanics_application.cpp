...
namespace Kratos
{
    ...
    void KratosParticleMechanicsApplication::Register()
    {
        ...
        // CL: Bounding Surface
        KRATOS_REGISTER_VARIABLE( INITIAL_MEAN_STRESS )
        KRATOS_REGISTER_VARIABLE( INITIAL_DEVIATORIC_STRESS )
        KRATOS_REGISTER_VARIABLE( SPECIFIC_VOLUME_REFERENCE )
        KRATOS_REGISTER_VARIABLE( IS_CSL_FIX )
        KRATOS_REGISTER_VARIABLE( BOUNDING_SURFACE_CURVATURE )
        KRATOS_REGISTER_VARIABLE( INITIAL_SCALING_HARDENING_PARAMETER )
        KRATOS_REGISTER_VARIABLE( RELOAD_SCALING_HARDENING_PARAMETER  )
        KRATOS_REGISTER_VARIABLE( MODEL_PARAMETER_R )
        KRATOS_REGISTER_VARIABLE( MODEL_PARAMETER_A )
        KRATOS_REGISTER_VARIABLE( MODEL_PARAMETER_K )
        ...
        Serializer::Register("BoundingSurfacePlasticFlowRule", mBoundingSurfacePlasticFlowRule);
        ...
        Serializer::Register("BoundingSurfaceYieldCriterion", mBoundingSurfaceYieldCriterion);
        ...
        Serializer::Register("BoundingSurfaceHardeningLaw", mBoundingSurfaceHardeningLaw);
