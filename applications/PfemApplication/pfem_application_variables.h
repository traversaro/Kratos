...
namespace Kratos
{
  ...
  //ALE Variables
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( PFEM_APPLICATION, MESH_DISPLACEMENT )
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( PFEM_APPLICATION, MESH_ACCELERATION )
