...
Projection = BinBasedMeshTransfer3D()
node_locator = BinBasedFastPointLocator3D(fixed_model_part)
node_locator_from_elem = BinBasedNodesInElementLocator3D(fixed_model_part)
