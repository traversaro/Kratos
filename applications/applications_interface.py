...
print("Import_PETScApplication: False")
...
def ImportApplications(kernel, applications_path=application_directory):
    ...
    print("Import_PETScApplication: " + str(Import_PETScApplication))
    ...
    if(Import_PETScApplication):
        print("importing KratosPETScApplication ...")
        sys.path.append(applications_path + '/PETSc/python_scripts')
        sys.path.append(applications_path + '/PETSc/Linux')
        from KratosPETScApplication import *
        pet_sc_application = KratosPETScApplication()
        kernel.ImportApplication(pet_sc_application)
        print("KratosPETScApplication Succesfully imported")
    ...
    if(Import_PETScApplication):
        kernel.InitializeApplication(pet_sc_application)
