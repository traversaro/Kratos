...
class Algorithm(BaseAlgorithm):
    ...
    def SetFluidAlgorithm(self):
        import pfem_fluid_app_ready_for_dem_coupling as fluid_solution
    ...
    def SetCouplingParameters(self, varying_parameters):
        ...
        self.pp.domain_size = self.fluid_solution.ProjectParameters["model_settings"]["dimension"].GetInt()
