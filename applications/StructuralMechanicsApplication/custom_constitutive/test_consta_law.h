...
#if !defined (KRATOS_TEST_CONSTA_LAW_H_INCLUDED)
#define  KRATOS_TEST_CONSTA_LAW_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) TestConstaLaw 
...
public:
    ...
    /// Counted pointer of TestConstaLaw
    KRATOS_CLASS_POINTER_DEFINITION( TestConstaLaw );
     ...
     * Copy constructor.
     */
    TestConstaLaw (const TestConstaLaw& rOther);

    /**
     * @brief Destructor.
     */
    ~TestConstaLaw() override;
