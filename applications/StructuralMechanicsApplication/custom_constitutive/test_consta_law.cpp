...
TestConstaLaw::TestConstaLaw(const TestConstaLaw& rOther)
...
ConstitutiveLaw::Pointer TestConstaLaw::Clone() const
{
    return Kratos::make_shared<TestConstaLaw>(*this);
}
...
void  TestConstaLaw::CalculateMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    KRATOS_TRY;
    ...
    //std::cout<< r_constitutive_matrix <<std::endl;
	KRATOS_WATCH(this->GetParam())

    
    //std::cout<< "la componenet.... " << r_stress_vector[0] << std::endl;
...
void TestConstaLaw::CalculateMaterialResponsePK1 (ConstitutiveLaw::Parameters& rValues)
{
...
void TestConstaLaw::CalculateMaterialResponseKirchhoff (ConstitutiveLaw::Parameters& rValues)
{
    CalculateMaterialResponsePK2(rValues);
}
...
void TestConstaLaw::CalculateMaterialResponseCauchy (ConstitutiveLaw::Parameters& rValues)
{
    CalculateMaterialResponsePK2(rValues);
}
...
void TestConstaLaw::FinalizeMaterialResponsePK1(ConstitutiveLaw::Parameters& rValues)
{
...
void TestConstaLaw::FinalizeMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    // TODO: Add if necessary
}
...
void TestConstaLaw::FinalizeMaterialResponseCauchy(ConstitutiveLaw::Parameters& rValues)
{
    // TODO: Add if necessary
}
...
void TestConstaLaw::FinalizeMaterialResponseKirchhoff(ConstitutiveLaw::Parameters& rValues)
{
    // TODO: Add if necessary
}
...
double& TestConstaLaw::CalculateValue(ConstitutiveLaw::Parameters& rParameterValues, const Variable<double>& rThisVariable, double& rValue)
{
...
Vector& TestConstaLaw::CalculateValue(
...
Matrix& TestConstaLaw::CalculateValue(
    ConstitutiveLaw::Parameters& rParameterValues,
...
void TestConstaLaw::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
void TestConstaLaw::CheckClearElasticMatrix(Matrix& rConstitutiveMatrix)
{
...
void TestConstaLaw::CalculateElasticMatrix(
...
void TestConstaLaw::CalculatePK2Stress(
...
void TestConstaLaw::CalculateCauchyGreenStrain(
    ConstitutiveLaw::Parameters& rValues,
