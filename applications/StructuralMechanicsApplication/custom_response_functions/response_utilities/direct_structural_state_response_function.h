...
#ifndef DIRECT_STRUCTURAL_STATE_RESPONSE_FUNCTION_H
#define DIRECT_STRUCTURAL_STATE_RESPONSE_FUNCTION_H
...
/** \brief DirectStructuralStateResponseFunction
*
...
*/
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) DirectStructuralStateResponseFunction
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION(DirectStructuralStateResponseFunction);
    ...
    /// Constructor.
    DirectStructuralStateResponseFunction(ModelPart& rModelPart, Parameters ResponseSettings);

    /// Destructor.
    virtual ~DirectStructuralStateResponseFunction();
...
#endif /* KRATOS_DIRECT_STRUCTURAL_STATE_RESPONSE_FUNCTION defined */
