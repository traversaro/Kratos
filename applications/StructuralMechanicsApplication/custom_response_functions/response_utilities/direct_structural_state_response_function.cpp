...
#include "direct_structural_state_response_function.h"
...
namespace Kratos
{
    ...
    /// Constructor.
    DirectStructuralStateResponseFunction::DirectStructuralStateResponseFunction(ModelPart& rModelPart, Parameters ResponseSettings)
      : mrModelPart(rModelPart)
    {
        KRATOS_TRY;

        mSensitivityModelPartName = ResponseSettings["sensitivity_model_part_name"].GetString();
        //MFusseder TODO: don't it use for shape sensitivities, because of interactions of multible nodes and interaction with derivatives 
        // of element and condition sensitivity variables. maybe derive this class for the three different types of variables?
    ...
    /// Destructor.
    DirectStructuralStateResponseFunction::~DirectStructuralStateResponseFunction()
    {
    }

    ModelPart& DirectStructuralStateResponseFunction::GetModelPart()
    {
      return mrModelPart;
    }

    ModelPart& DirectStructuralStateResponseFunction::GetModelPart() const
    {
      return mrModelPart;
    }

    void DirectStructuralStateResponseFunction::Initialize()
    {
        KRATOS_TRY;
        ...
        //MFusseder TODO: If DV = SHAPE of a specific node than also a flag has to be set to the neighboring elements and conditions!
    ...
    void DirectStructuralStateResponseFunction::InitializeSolutionStep(){}

    void DirectStructuralStateResponseFunction::FinalizeSolutionStep()
    {
        KRATOS_TRY;
    ...
    void DirectStructuralStateResponseFunction::Check()
    {
        KRATOS_TRY;
    ...
    void DirectStructuralStateResponseFunction::Clear()
    {
        KRATOS_TRY;
     ...
     */
    void DirectStructuralStateResponseFunction::CalculateGradient(Element& rAdjointElem,
                                   ...
                                   ProcessInfo& rProcessInfo)
    {
        ...
        if (rAdjointElem.GetValue(UPDATE_SENSITIVITIES))
        {
            ...
            if(mElementSensitivityScalarVariables.size() > 0)
            {
                const auto& variable_pair =  mElementSensitivityScalarVariables[0];
                rAdjointElem.CalculateSensitivityMatrix(
                    variable_pair[0], sensitivity_matrix, rProcessInfo);
            } 
            else if(mElementSensitivityVectorVariables.size() > 0)
            {
                const auto& variable_pair =  mElementSensitivityVectorVariables[0];
                rAdjointElem.CalculateSensitivityMatrix(
                    variable_pair[0], sensitivity_matrix, rProcessInfo);
            }

            KRATOS_ERROR_IF(sensitivity_matrix.size2() != rResponseGradient.size())  << "Size of pseudo load does not fit!" << std::endl;

            for(IndexType j = 0; j < rResponseGradient.size(); ++j)
                rResponseGradient[j] = sensitivity_matrix(0,j);
        }    
        
        KRATOS_CATCH("");
    }

    void DirectStructuralStateResponseFunction::CalculateGradient(const Condition& rAdjointCondition,
                                   const Matrix& rAdjointMatrix,
                                   Vector& rResponseGradient,
                                   ProcessInfo& rProcessInfo)
    {
     ...
     * @param[in]     rProcessInfo      the current process info.
     */
    void DirectStructuralStateResponseFunction::CalculateFirstDerivativesGradient(const Element& rAdjointElem,
                                                   const Matrix& rAdjointMatrix,
                                                   Vector& rResponseGradient,
                                                   ProcessInfo& rProcessInfo)
    {
    ...
    void DirectStructuralStateResponseFunction::CalculateFirstDerivativesGradient(const Condition& rAdjointCondition,
                                                   const Matrix& rAdjointMatrix,
                                                   Vector& rResponseGradient,
                                                   ProcessInfo& rProcessInfo)
    {
     ...
     * @param[in]     rProcessInfo      the current process info.
     */
    void DirectStructuralStateResponseFunction::CalculateSecondDerivativesGradient(const Element& rAdjointElem,
                                                    const Matrix& rAdjointMatrix,
                                                    Vector& rResponseGradient,
                                                    ProcessInfo& rProcessInfo)
    {
    ...
    void DirectStructuralStateResponseFunction::CalculateSecondDerivativesGradient(const Condition& rAdjointCondition,
                                                    const Matrix& rAdjointMatrix,
                                                    Vector& rResponseGradient,
                                                    ProcessInfo& rProcessInfo)
    {
    ...
    void DirectStructuralStateResponseFunction::UpdateSensitivities()
    {
        KRATOS_TRY;
    ...
    double DirectStructuralStateResponseFunction::CalculateValue(ModelPart& rModelPart)
    {
        return 0.0;
    }

    template <typename TDataType>
    void DirectStructuralStateResponseFunction::UpdateNodalSensitivities(Variable<TDataType> const& rSensitivityVariable, Variable<TDataType> const& rOutputVariable)
    {
        KRATOS_TRY;
    ...
    template <typename TDataType>
    void DirectStructuralStateResponseFunction::UpdateElementSensitivities(Variable<TDataType> const& rSensitivityVariable, Variable<TDataType> const& rOutputVariable)
    {
        KRATOS_TRY;
    ...
    template <typename TDataType>
    void DirectStructuralStateResponseFunction::UpdateConditionSensitivities(Variable<TDataType> const& rSensitivityVariable, Variable<TDataType> const& rOutputVariable)
    {
        KRATOS_TRY;
     ...
     */
    void DirectStructuralStateResponseFunction::CalculateSensitivityGradient(Element& rAdjointElem,
    ...
    void DirectStructuralStateResponseFunction::CalculateSensitivityGradient(Condition& rAdjointCondition,
                                              const Variable<double>& rVariable,
                                              const Matrix& rDerivativesMatrix,
                                              Vector& rResponseGradient,
                                              ProcessInfo& rProcessInfo)
    ...
    void DirectStructuralStateResponseFunction::AssembleNodalSensitivityContribution(Variable<double> const& rSensitivityVariable,
    ...
    void DirectStructuralStateResponseFunction::AssembleNodalSensitivityContribution(Variable<array_1d<double, 3>> const& rSensitivityVariable,
                                              Vector const& rSensitivityVector,
                                              Element::GeometryType& rGeom)
    {
        IndexType index = 0;
    ...
    void DirectStructuralStateResponseFunction::AssembleElementSensitivityContribution(Variable<double> const& rSensitivityVariable,
                                                Vector const& rSensitivityVector,
                                                Element& rElem)
    {
    ...
    void DirectStructuralStateResponseFunction::AssembleElementSensitivityContribution(Variable<array_1d<double, 3>> const& rSensitivityVariable,
                                                Vector const& rSensitivityVector,
                                                Element& rElem)
    {
    ...
    void DirectStructuralStateResponseFunction::AssembleConditionSensitivityContribution(Variable<double> const& rSensitivityVariable,
                                              Vector const& rSensitivityVector,
                                              Element::GeometryType& rGeom)
    {
        IndexType index = 0;
    ...
    void DirectStructuralStateResponseFunction::AssembleConditionSensitivityContribution(Variable<array_1d<double, 3>> const& rSensitivityVariable,
                                              Vector const& rSensitivityVector,
                                              Element::GeometryType& rGeom)
    {
        IndexType index = 0;
    ...
    void DirectStructuralStateResponseFunction::ReadDesignVariables(std::vector<std::vector<Variable<double>>>& rScalarDesignVariables,
