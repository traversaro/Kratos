...
public:
    ...
    /// Constructor.
    DirectStructuralStaticScheme(Parameters rParameters, DirectStructuralStateResponseFunction::Pointer pResponseFunction)
...
private:
    ...
    DirectStructuralStateResponseFunction::Pointer mpResponseFunction;
