...
def CreateSolver(model, custom_settings):
    ...
    if (parallelism == "OpenMP"):
        ...
        elif (solver_type == "direct_static"):
            solver_module_name = "structural_mechanics_direct_static_solver"

        else:
            err_msg =  "The requested solver type \"" + solver_type + "\" is not in the python solvers wrapper\n"
            err_msg += "Available options are: \"static\", \"dynamic\", \"eigen_value\", \"harmonic_analysis\", \"formfinding\", \"adjoint_static\", \"direct_static\""
            raise Exception(err_msg)
