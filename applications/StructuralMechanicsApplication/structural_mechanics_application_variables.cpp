...
KRATOS_CREATE_VARIABLE(Matrix, PRESTRESS_AXIS_1_GLOBAL)
KRATOS_CREATE_VARIABLE(Matrix, PRESTRESS_AXIS_2_GLOBAL)
KRATOS_CREATE_VARIABLE(Matrix, PRESTRESS_AXIS_1_LOCAL)
KRATOS_CREATE_VARIABLE(Matrix, PRESTRESS_AXIS_2_LOCAL)
